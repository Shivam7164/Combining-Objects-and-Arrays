let movies = [
  ...
  */
  ...
  console.log(movies[1].genres[movies.length-3]);
 ...
 for(let i = 0;i<movies.length;i++){
  ...
  for(let Number of movies){
    console.log(Number.year>2017 ? true:false)
}
